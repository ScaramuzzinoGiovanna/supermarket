                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body w-100 text-center bodyModalLocation">
                                <!--<form class="form-inline my-2 my-lg-0 " method="get" action="utility/location.php">
                                    <div class="input-group">
                                        <input class="form-control py-2 border-right-0 border" type="search" id="loc" name='loc' autocomplete="off" placeholder="Inserisci la tua località">
                                        <span class="input-group-append">
                                            <button class="btn btn-outline-secondary border-left-0 border" type="submit">
                                                <img class="" src="images/search.svg" alt="cerca">
                                            </button>
                                ...
                                <div class="input-group mb-2">
                                 <input class="form-control py-2 pinkInput" type="text" id="loc" name='loc' autocomplete="off" placeholder="Inserisci la tua località">
                                    <span class="input-group-append">
                                    <button class="btn btn-secondary border-left-0 border" type="button" onclick="loadGeo()">
                                        Invio
                                    </button>
                                </span>
                                </div>
                                <p>oppure</p>
                                <div class="">
                                    <button class="btn btn-secondary" onclick="geo()">
                                        <img class="iconGPS" src="images/geo.png" alt="gps">
                                        Geolocalizzati
                                    </button>
                                </div>
